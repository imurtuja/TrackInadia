...
const About = () => {
  useEffect(() => {
    document.title = "About | TrackFlow by Murtuja";
  }, []);
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-slate-300 max-w-4xl mx-auto mb-16 leading-relaxed">
              Revolutionizing package tracking in India with a unified platform that connects 
              all major courier services under one professional interface.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-lg text-slate-300 mb-6 leading-relaxed">
              At TrackFlow, we believe that tracking packages shouldn't be complicated. 
              With over 13 major courier services operating in India, customers often find 
              themselves juggling between multiple websites and apps to track their deliveries.
            </p>
            <p className="text-lg text-slate-300 mb-6 leading-relaxed">
              Our mission is to simplify this process by providing a unified, professional 
              platform that allows users to track packages from any Indian courier service 
              through a single, intuitive interface.
            </p>
            <p className="text-lg text-slate-300 leading-relaxed">
              We're committed to delivering real-time, accurate tracking information while 
          ...
          <div className="bg-slate-800/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-slate-700/50 p-8">
            <div className="space-y-6">
              <div className="flex items-center">
                ...
                <div>
                  <h3 className="text-lg font-bold text-white">Unified Tracking</h3>
                  <p className="text-slate-300">One platform for all courier services</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-slate-300">Instant delivery status notifications</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-slate-300">Your data is never stored on our servers</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-4 gap-6 sm:gap-8">
            <div className="text-center group">
              ...
              <div className="text-2xl sm:text-4xl font-bold text-emerald-400 mb-2">13+</div>
              <div className="text-slate-300 text-xs sm:text-base font-medium">Courier Services</div>
            </div>
            ...
            <div className="text-center group">
              ...
              <div className="text-2xl sm:text-4xl font-bold text-teal-400 mb-2">50K+</div>
              <div className="text-slate-300 text-xs sm:text-base font-medium">Active Users</div>
            </div>
            ...
            <div className="text-center group">
              ...
              <div className="text-2xl sm:text-4xl font-bold text-cyan-400 mb-2">1M+</div>
              <div className="text-slate-300 text-xs sm:text-base font-medium">Packages Tracked</div>
            </div>
            ...
            <div className="text-center group">
              ...
              <div className="text-slate-300 text-xs sm:text-base font-medium">Uptime</div>
            </div>
          </div>
        </div>
      </div>
