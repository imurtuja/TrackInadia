        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-slate-300 max-w-4xl mx-auto mb-16 leading-relaxed">
              Have questions about TrackFlow? We're here to help! Reach out to our team 
              for support, partnerships, or any inquiries about our services.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-slate-300 mb-8">
                We're here to help with any questions about TrackFlow. 
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-400">Monday - Friday, 9:00 AM - 6:00 PM IST</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-slate-300 mb-1">TrackFlow Technologies Pvt. Ltd.</p>
                  <p className="text-slate-300 mb-1">123 Tech Park, Hi-tech City</p>
                  <p className="text-slate-300 mb-1">Hyderabad, Telangana 500081</p>
            ...
            <div className="pt-8 border-t border-slate-600">
              <h3 className="text-xl font-bold text-white mb-6 text-center sm:text-left">Follow Us</h3>
              <div className="flex justify-center sm:justify-start space-x-4">
                <a href="https://twitter.com/trackflow" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-slate-700/80 backdrop-blur-sm hover:bg-emerald-500/20 rounded-xl flex items-center justify-center transition-all duration-300 transform hover:scale-110 border border-slate-600 shadow-md">
                ...
                <a href="https://facebook.com/trackflow" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-slate-700/80 backdrop-blur-sm hover:bg-emerald-500/20 rounded-xl flex items-center justify-center transition-all duration-300 transform hover:scale-110 border border-slate-600 shadow-md">
                  <svg className="w-6 h-6 text-slate-300" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://pinterest.com/trackflow" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-slate-700/80 backdrop-blur-sm hover:bg-emerald-500/20 rounded-xl flex items-center justify-center transition-all duration-300 transform hover:scale-110 border border-slate-600 shadow-md">
                  <svg className="w-6 h-6 text-slate-300" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-6">
            <div className="bg-slate-800/80 backdrop-blur-sm rounded-2xl shadow-xl border border-slate-700/50 p-6">
              ...
              <p className="text-slate-300">
                TrackFlow connects directly to official courier service APIs to provide real-time tracking information. 
                Simply enter your tracking number and select the courier service to get instant updates.
              </p>
            </div>
            ...
            <div className="bg-slate-800/80 backdrop-blur-sm rounded-2xl shadow-xl border border-slate-700/50 p-6">
              ...
              <p className="text-slate-300">
                Yes! We never store your tracking data on our servers. All information is processed in real-time 
                and immediately discarded after providing you with the tracking results.
              </p>
            </div>
            ...
            <div className="bg-slate-800/80 backdrop-blur-sm rounded-2xl shadow-xl border border-slate-700/50 p-6">
              ...
              <p className="text-slate-300">
                We currently support 13+ major Indian courier services including Blue Dart, Delhivery, DTDC, 
                India Post, FedEx India, DHL, Aramex, and many more. Check our Services page for the complete list.
              </p>
            </div>
            ...
            <div className="bg-slate-800/80 backdrop-blur-sm rounded-2xl shadow-xl border border-slate-700/50 p-6">
              ...
              <p className="text-slate-300">
                Yes! TrackFlow is completely free to use. We believe that package tracking should be accessible 
