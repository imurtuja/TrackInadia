...
const Services = () => {
  useEffect(() => {
    document.title = "Services | TrackIndia by Murtuja";
  }, []);
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-slate-300 max-w-4xl mx-auto mb-16 leading-relaxed">
              ...
              real-time updates, professional tracking, and comprehensive
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-6">
              Why Choose TrackIndia?
            </h2>
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Professional tracking solutions with comprehensive coverage and
              real-time updates
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center group">
              ...
              <p className="text-slate-300">
                Get instant notifications and real-time tracking updates for all
                your packages
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-slate-300">
                Direct integration with official courier APIs ensures accurate
                tracking data
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <p className="text-slate-300">
                Your tracking data is encrypted and never stored on our servers
              </p>
            </div>
          </div>
        </div>
