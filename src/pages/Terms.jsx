...
const Terms = () => {
  useEffect(() => {
    document.title = "Terms of Service | TrackIndia by Murtuja";
  }, []);
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-slate-300 max-w-4xl mx-auto mb-16 leading-relaxed">
              These terms and conditions govern your use of TrackIndia's package
              tracking services. Please read them carefully before using our
              platform.
            </p>
        ...
        <div className="space-y-12">
          ...
          <div className="bg-slate-800/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-slate-700/50 p-8">
            ...
            <p className="text-slate-300 mb-4 leading-relaxed">
              By accessing and using TrackIndia ("the Service"), you accept and
          ...
          <div className="bg-slate-800/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-slate-700/50 p-8">
            ...
            <p className="text-slate-300 mb-4 leading-relaxed">
              TrackIndia is a package tracking platform that provides users with
              the ability to track packages across multiple Indian courier
              services through a unified interface. Our service aggregates
              tracking information from various courier companies and presents
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                ...
                <p className="text-slate-300">
                  Real-time package tracking across multiple courier services
                </p>
              </div>
              <div className="flex items-start">
                <div className="w-2 h-2 bg-emerald-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                <p className="text-slate-300">
                  Unified interface for all supported courier companies
                </p>
              </div>
              <div className="flex items-start">
                <div className="w-2 h-2 bg-emerald-500 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                <p className="text-slate-300">
                  Direct links to official courier tracking pages
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-800/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-slate-700/50 p-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-slate-300">
                  You are responsible for providing accurate tracking numbers
                  and selecting the correct courier service. We are not liable
                  for tracking errors resulting from incorrect information
                  provided by users.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-slate-300">
                  You may not use automated systems, bots, or scripts to access
                  the service in a manner that could interfere with or disrupt
          ...
          <div className="bg-slate-800/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-slate-700/50 p-8">
            ...
            <div className="space-y-4">
              <p className="text-slate-300">
                ...
                TrackIndia Technologies Pvt. Ltd. and its licensors. The Service
              ...
              <p className="text-slate-300">
                All courier service logos and trademarks displayed on our
                platform belong to their respective owners. We do not claim
                ownership of these third-party trademarks.
              </p>
            </div>
          </div>
          ...
          <div className="bg-slate-800/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-slate-700/50 p-8">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-slate-300">
                  We provide tracking information as received from courier
                  services. We do not guarantee the accuracy, completeness, or
                  timeliness of tracking information. Users should verify
                  tracking details with the respective courier service.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-slate-300">
                  Our service integrates with third-party courier services. We
              ...
              <div>
                ...
                <p className="text-slate-300">
                  In no event shall TrackIndia Technologies Pvt. Ltd. be liable
          ...
          <div className="bg-slate-800/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-slate-700/50 p-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <span className="text-slate-300">
                  Address: TrackIndia Technologies Pvt. Ltd., 123 Tech Park,
