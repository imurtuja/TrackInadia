  ...
  return (
    <footer className="bg-gradient-to-br from-slate-800 via-slate-900 to-slate-800 text-white relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-3 sm:px-4 lg:px-8 py-6 sm:py-8 lg:py-12 relative z-10">
        {/* Mobile Layout: Company Info (full width) + Quick Links & Support (side by side) */}
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li>
                    <Link
                      to="/"
                      className="text-slate-300 hover:text-emerald-400 transition-all duration-300 group flex items-center text-xs"
                    >
        ...
        {/* Desktop Layout: Traditional 4-column grid */}
        <div className="hidden lg:block">
          <div className="grid grid-cols-4 gap-8">
            {/* Company Info - 2 columns on desktop */}
            <div className="col-span-2">
              ...
              <p className="text-base text-slate-300 mb-6 max-w-md leading-relaxed">
                The most comprehensive package tracking platform for Indian
                courier services. Track your packages across all major courier
                companies with real-time updates.
              </p>
              ...
              <div className="flex space-x-3">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-slate-700/80 backdrop-blur-sm hover:bg-blue-500/20 rounded-xl flex items-center justify-center transition-all duration-300 transform hover:scale-110 border border-slate-600 shadow-md group"
                >
                  <svg
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-slate-700/80 backdrop-blur-sm hover:bg-gray-500/20 rounded-xl flex items-center justify-center transition-all duration-300 transform hover:scale-110 border border-slate-600 shadow-md group"
                >
                  <svg
                    className="w-5 h-5 text-slate-300 group-hover:text-gray-400 transition-colors"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-slate-700/80 backdrop-blur-sm hover:bg-pink-500/20 rounded-xl flex items-center justify-center transition-all duration-300 transform hover:scale-110 border border-slate-600 shadow-md group"
                >
                  <svg
                    className="w-5 h-5 text-slate-300 group-hover:text-pink-400 transition-colors"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
                    <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z" />
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link
                    to="/"
                    className="text-slate-300 hover:text-emerald-400 transition-all duration-300 group flex items-center text-sm"
                  >
                    <span className="w-1.5 h-1.5 bg-emerald-500 rounded-full mr-2 group-hover:scale-150 transition-transform"></span>
                    Home
                  </Link>
        ...
        {/* Footer Bottom - Same for both mobile and desktop */}
        <div className="border-t border-slate-600 mt-6 sm:mt-8 pt-4 sm:pt-6">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-3 lg:space-y-0">
            ...
            <motion.div
              className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 backdrop-blur-sm rounded-lg sm:rounded-xl p-3 sm:p-4 border border-purple-500/30 lg:order-2"
            ...
            <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-4 lg:order-3">
